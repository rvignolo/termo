#!/bin/sh
# take the output of this script as a kate syntax definition file for mate
#
# ./syntax-kate.sh > $HOME/.kde/share/apps/katepart/syntax/mate.xml
#
...
<language name="mate" version="0.5" kateversion="3.7.4" section="Scientific" extensions="*.mat" author="ramiro vignolo" license="GPL">
EOF
